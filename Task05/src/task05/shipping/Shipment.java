...
public class Shipment<T extends Product> {
    ...
    public Shipment(T cargo, String destination,
                    int priorityOverride, boolean fragile, boolean insured){
        this.cargo = cargo;
    ...
    public String toString() {
        return String.format("Shipment{cargo=%s, destination='%s', priorityOverride=%d, fragile=%s, insured=%s}",
                cargo,
                destination,
                priorityOverride,
                fragile,
